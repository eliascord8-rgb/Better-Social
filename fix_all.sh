...
# 2. Fix Root & Dashboard
sed -i "s/import { PageLoader }/\/\/ import { PageLoader }/g" src/routes/__root.tsx
sed -i "s/import { PageLoader }/\/\/ import { PageLoader }/g" src/router.tsx

# 3. Clean and Build
rm -rf .tanstack .output
npx tsr generate
npm run build
pm2 restart better-social
